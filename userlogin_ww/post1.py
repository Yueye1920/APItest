...
class Testlogin:
    # 请求行
    url_login = 'http://124.71.196.93:9000/missLogin/sso/v1/userlogin'
    # 请求头
    ...
    def test_login_password_error(self):
        ...
        login_data = {
            "username": "VzAwMTAwMTAxMg==",
            "password": "ZjY0MmU4NmI3NTg5MDQzYjM0M2U1ZThiYTUxNGNhMD",
            "captcha": "MjAyNA=="
        }
        # 发起请求（url,data=bady,headers=headers）
